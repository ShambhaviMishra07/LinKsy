// client/src/pages/FollowersList.jsx
  ...
  return (
    <div style={{ background: c.bg, minHeight: '100vh', color: c.textPrimary }}>
      <div style={{
        ...
        <span style={{ fontSize: 16, fontWeight: 500 }}>Followers</span>
      </div>
      <div style={{ maxWidth: 480, margin: '0 auto' }}>
        {loading && <p style={{ textAlign: 'center', color: c.textMuted, padding: 20 }}>Loading...</p>}
        {!loading && followers.length === 0 && (
          <p style={{ textAlign: 'center', color: c.textMuted, padding: 40 }}>No followers yet</p>
        )}
        {followers.map(u => (
          <div
            key={u._id}
